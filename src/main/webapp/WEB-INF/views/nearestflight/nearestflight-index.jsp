...
<div class="container">
    <div class="row">
        <div class="col-lg-12 text-center">
            <h1 class="my-5 mt-5">Find Nearest Flight</h1>
        </div>
    </div>
</div>
...
<div class="py-0">
    <div class="container">
        <div class="row">
            <div class="offset-md-2 col-md-8" style=""> enter geographic coordinates in decimal format e.g. for Warsaw
                latitude = 52.2297700 and longitude <br>= 21.0117800
            </div>
        </div>
    </div>
</div>
