...
public class CountryRESTController {
    ...
    @RequestMapping(value = "/projects/addressbookdatabase/population", consumes = MediaType.TEXT_PLAIN_VALUE, method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/projects/addressbookdatabase/continents", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/projects/addressbookdatabase/name", consumes = MediaType.TEXT_PLAIN_VALUE, method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/projects/addressbookdatabase/continent", consumes = MediaType.TEXT_PLAIN_VALUE, method = RequestMethod.POST)
     ...
     */
    @RequestMapping(value = "/projects/addressbookdatabase/countries", produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = "/projects/addressbookdatabase/countries", consumes = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.POST)
